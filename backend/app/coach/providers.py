...
_SYSTEM_PROMPT_RU = (
    ...
    "- В тексте только русские слова, без английских названий полей: steer_reversals → "
    "«подруливания», apex → «апекс», brake_to_apex_m → «метров до апекса», entry/exit → «вход/выход».\n"
